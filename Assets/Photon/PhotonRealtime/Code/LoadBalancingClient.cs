...
namespace Photon.Realtime
{
    ...
    public class LoadBalancingClient : IPhotonPeerListener
    {
        ...
        public NPlayer LocalPlayer { get; internal set; }
        ...
        protected internal bool OpSetPropertiesOfActor(int actorNr, Hashtable actorProperties, Hashtable expectedProperties = null, WebFlags webFlags = null)
        {
            ...
            {
                NPlayer target = this.CurrentRoom.GetPlayer(actorNr);
                if (target != null)
                {
        ...
        private void ReadoutProperties(Hashtable gameProperties, Hashtable actorProperties, int targetActorNr)
        {
            ...
            if (actorProperties != null && actorProperties.Count > 0)
            {
                if (targetActorNr > 0)
                {
                    ...
                    NPlayer target = this.CurrentRoom.GetPlayer(targetActorNr);
                    if (target != null)
                    {
        ...
        private void UpdatedActorList(int[] actorsInGame)
        {
            if (actorsInGame != null)
            {
                foreach (int actorNumber in actorsInGame)
                {
                    ...
                    NPlayer target = this.CurrentRoom.GetPlayer(actorNumber);
                    if (target == null)
                    {
        ...
        protected internal virtual NPlayer CreatePlayer(string actorName, int actorNumber, bool isLocal, Hashtable actorProperties)
        {
            NPlayer newPlayer = new NPlayer(actorName, actorNumber, isLocal, actorProperties);
            return newPlayer;
        }
        ...
        public virtual void OnEvent(EventData photonEvent)
        {
            ...
            NPlayer originatingPlayer = (this.CurrentRoom != null) ? this.CurrentRoom.GetPlayer(actorNr) : null;
    ...
    public interface IInRoomCallbacks
    {
        ...
        /// </remarks>
        void OnPlayerEnteredRoom(NPlayer newPlayer);
        ...
        /// </remarks>
        void OnPlayerLeftRoom(NPlayer otherPlayer);
        ...
        void OnPlayerPropertiesUpdate(NPlayer targetPlayer, Hashtable changedProps);
        ...
        /// </remarks>
        void OnMasterClientSwitched(NPlayer newMasterClient);
    }
    ...
    internal class InRoomCallbacksContainer : List<IInRoomCallbacks>, IInRoomCallbacks
    {
        ...
        public void OnPlayerEnteredRoom(NPlayer newPlayer)
        {
            this.client.UpdateCallbackTargets();
        ...
        public void OnPlayerLeftRoom(NPlayer otherPlayer)
        {
            this.client.UpdateCallbackTargets();
        ...
        public void OnPlayerPropertiesUpdate(NPlayer targetPlayer, Hashtable changedProp)
        {
            this.client.UpdateCallbackTargets();
        ...
        public void OnMasterClientSwitched(NPlayer newMasterClient)
        {
            this.client.UpdateCallbackTargets();
