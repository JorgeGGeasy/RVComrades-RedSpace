...
namespace Photon.Realtime
{
    ...
    public class NPlayer
    {
        ...
        protected internal NPlayer(string nickName, int actorNumber, bool isLocal) : this(nickName, actorNumber, isLocal, null)
        {
        }
        ...
        protected internal NPlayer(string nickName, int actorNumber, bool isLocal, Hashtable playerProperties)
        {
        ...
        /// <returns>Player or null.</returns>
        public NPlayer GetNextFor(NPlayer currentPlayer)
        {
        ...
        /// <returns>Player or null.</returns>
        public NPlayer GetNextFor(int currentPlayerId)
        {
            ...
            Dictionary<int, NPlayer> players = this.RoomReference.Players;
