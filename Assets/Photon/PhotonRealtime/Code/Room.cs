...
namespace Photon.Realtime
{
    ...
    public class Room : RoomInfo
    {
        ...
        private Dictionary<int, NPlayer> players = new Dictionary<int, NPlayer>();

        /// <summary>While inside a Room, this is the list of players who are also in that room.</summary>
        public Dictionary<int, NPlayer> Players
        {
            get
            {
                return this.players;
        ...
        /// </summary>
        protected internal virtual void RemovePlayer(NPlayer player)
        {
        ...
        public bool SetMasterClient(NPlayer masterClientPlayer)
        {
            if (this.isOffline)
            {
                return false;
        ...
        public virtual bool AddPlayer(NPlayer player)
        {
        ...
        public virtual NPlayer StorePlayer(NPlayer player)
        {
        ...
        public virtual NPlayer GetPlayer(int id, bool findMaster = false)
        {
