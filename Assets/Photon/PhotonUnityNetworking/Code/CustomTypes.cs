...
namespace Photon.Pun
{
    ...
    internal static class CustomTypes
    {
        ...
        {
            PhotonPeer.RegisterType(typeof(NPlayer), (byte) 'P', SerializePhotonPlayer, DeserializePhotonPlayer);
        }
        ...
        {
            int ID = ((NPlayer) customobject).ActorNumber;
        ...
        private static object DeserializePhotonPlayer(StreamBuffer inStream, short length)
        {
            ...
            {
                NPlayer player = PhotonNetwork.CurrentRoom.GetPlayer(ID);
                return player;
            }
            return null;
        }
