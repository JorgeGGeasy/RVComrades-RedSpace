...
namespace Photon.Pun
{
    ...
    public interface IPunOwnershipCallbacks
    {
        ...
        void OnOwnershipRequest(PhotonView targetView, NPlayer requestingPlayer);
        ...
        void OnOwnershipTransfered(PhotonView targetView, NPlayer previousOwner);
        ...
        void OnOwnershipTransferFailed(PhotonView targetView, NPlayer senderOfFailedRequest);
    }
