...
namespace Photon.Pun
{
    ...
    public struct InstantiateParameters
    {
        ...
        public NPlayer creator;
        public int timestamp;

        public InstantiateParameters(string prefabName, Vector3 position, Quaternion rotation, byte @group, object[] data, byte objLevelPrefix, int[] viewIDs, NPlayer creator, int timestamp)
        {
    ...
    public static partial class PhotonNetwork
    {
        ...
        /// </summary>
        public static NPlayer[] PlayerList
        {
            get
            {
        ...
        /// </summary>
        public static NPlayer[] PlayerListOthers
        {
            get
            {
                Room room = CurrentRoom;
        ...
        /// </remarks>
        public static NPlayer MasterClient
        {
            get
            {
                if (OfflineMode)
        ...
        public static bool CloseConnection(NPlayer kickPlayer)
        {
            if (!VerifyCanUseNetwork())
            {
                return false;
        ...
        public static bool SetMasterClient(NPlayer masterClientPlayer)
        {
        ...
        private static GameObject NetworkInstantiate(Hashtable networkEvent, NPlayer creator)
        {
        ...
        /// </remarks>
        /// <returns>Nothing. Check error debug log for any issues.</returns>
        public static void DestroyPlayerObjects(NPlayer targetPlayer)
        {
        ...
        public static void RemoveRPCs(NPlayer targetPlayer)
        {
            if (!VerifyCanUseNetwork())
            {
                return;
        ...
        /// Internal to send an RPC on given PhotonView. Do not call this directly but use: PhotonView.RPC!
        /// </summary>
        internal static void RPC(PhotonView view, string methodName, NPlayer targetPlayer, bool encrypt, params object[] parameters)
        {
            if (!VerifyCanUseNetwork())
            {
                return;
