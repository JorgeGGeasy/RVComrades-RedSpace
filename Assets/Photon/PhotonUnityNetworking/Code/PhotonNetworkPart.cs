...
#pragma warning restore 0414
        ...
        /// </summary>
        internal static void ExecuteRpc(Hashtable rpcData, NPlayer sender)
        {
        ...
        internal static void RPC(PhotonView view, string methodName, RpcTarget target, NPlayer player, bool encrypt, params object[] parameters)
        {
        ...
        /// </summary>
        private static void OnSerializeRead(object[] data, NPlayer sender, int networkTime, short correctPrefix)
        {
        ...
        private static void OnEvent(EventData photonEvent)
        {
            ...
            NPlayer originatingPlayer = null;
                        ...
                        switch (requestedView.OwnershipTransfer)
                        {
                            case OwnershipOption.Takeover:
                                ...
                                if (requestedFromOwnerId == currentPvOwnerId || (requestedFromOwnerId == 0 && currentPvOwnerId == MasterClient.ActorNumber) || currentPvOwnerId == 0)
                                {
                                    ...
                                    NPlayer prevOwner = requestedView.Owner;
                ...
                case PunEvent.OwnershipUpdate:
                    {
                        ...
                        for (int i = 0, cnt = viewOwnerPair.Length; i < cnt; i++)
                        {
                            ...
                            NPlayer prevOwner = view.Owner;
                            NPlayer newOwner = CurrentRoom.GetPlayer(newOwnerId, true);
