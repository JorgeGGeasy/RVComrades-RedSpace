...
namespace Photon.Pun
{
    ...
    public class PhotonView : MonoBehaviour
    {
        ...
        public NPlayer Controller { get; private set; }
        ...
        /// The current owner has to implement IPunCallbacks.OnOwnershipRequest to react to the ownership request.
        /// </remarks>
        public NPlayer Owner { get; private set; }
        ...
        public int ControllerActorNr
        {
            ...
            set
            {
                NPlayer prevController = this.Controller;
        ...
        /// The owner/controller of a PhotonView is also the client which sends position updates of the GameObject.
        /// </remarks>
        public void TransferOwnership(NPlayer newOwner)
        {
            if (newOwner != null)
        ...
        /// <param name="parameters">The parameters that the RPC method has (must fit this call!).</param>
        public void RPC(string methodName, NPlayer targetPlayer, params object[] parameters)
        {
        ...
        ///<param name="encrypt"> </param>
        ///<param name="parameters">The parameters that the RPC method has (must fit this call!).</param>
        public void RpcSecure(string methodName, NPlayer targetPlayer, bool encrypt, params object[] parameters)
        {
