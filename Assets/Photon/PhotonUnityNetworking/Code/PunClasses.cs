...
namespace Photon.Pun
{
    ...
    public class MonoBehaviourPunCallbacks : MonoBehaviourPun, IConnectionCallbacks , IMatchmakingCallbacks , IInRoomCallbacks, ILobbyCallbacks, IWebRpcCallback, IErrorInfoCallback
    {
        ...
        /// </remarks>
        public virtual void OnMasterClientSwitched(NPlayer newMasterClient)
        {
        }
        ...
        /// </remarks>
        public virtual void OnPlayerEnteredRoom(NPlayer newPlayer)
        {
        }
        ...
        /// </remarks>
        public virtual void OnPlayerLeftRoom(NPlayer otherPlayer)
        {
        }
        ...
        public virtual void OnPlayerPropertiesUpdate(NPlayer targetPlayer, Hashtable changedProps)
        {
        }
    ...
    public struct PhotonMessageInfo
    {
        ...
        public readonly NPlayer Sender;
        public readonly PhotonView photonView;

        public PhotonMessageInfo(NPlayer player, int timestamp, PhotonView view)
        {
            this.Sender = player;
    ...
    public class PhotonStream
    {
        ...
        /// Will read or write the value, depending on the stream's IsWriting value.
        /// </summary>
        public void Serialize(ref NPlayer obj)
        {
            if (this.IsWriting)
            {
                this.writeData.Add(obj);
            ...
            else
            {
                if (this.readData.Length > this.currentItem)
                {
                    obj = (NPlayer) this.readData[this.currentItem];
                    this.currentItem++;
                }
            }
        }
