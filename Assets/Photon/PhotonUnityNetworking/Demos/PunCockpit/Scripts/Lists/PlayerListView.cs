...
namespace Photon.Pun.Demo.Cockpit
{
    ...
    public class PlayerListView : MonoBehaviourPunCallbacks
    {
        ...
        public override void OnEnable()
        {
            ...
            foreach (KeyValuePair<int, NPlayer> _entry in PhotonNetwork.CurrentRoom.Players)
            {
        ...
        public void SelectPlayer(NPlayer player)
        {
        ...
        public override void OnMasterClientSwitched(NPlayer newMasterClient)
        {
            foreach (KeyValuePair<int, NPlayer> _entry in PhotonNetwork.CurrentRoom.Players)
            {
        ...
        public override void OnPlayerPropertiesUpdate(NPlayer target, ExitGames.Client.Photon.Hashtable changedProps)
        {
