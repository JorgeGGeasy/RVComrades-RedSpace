...
namespace Photon.Pun.UtilityScripts
{
    ...
    public class PhotonTeamsManager : MonoBehaviour, IMatchmakingCallbacks, IInRoomCallbacks
    {
        ...
        private Dictionary<byte, HashSet<NPlayer>> playersPerTeam;
        ...
        public static event Action<NPlayer, PhotonTeam> PlayerJoinedTeam;
        public static event Action<NPlayer, PhotonTeam> PlayerLeftTeam;
        ...
        private void Init()
        {
            ...
            playersPerTeam = new Dictionary<byte, HashSet<NPlayer>>(teamsList.Count);
            for (int i = 0; i < teamsList.Count; i++)
            {
                teamsByCode[teamsList[i].Code] = teamsList[i];
                teamsByName[teamsList[i].Name] = teamsList[i];
                playersPerTeam[teamsList[i].Code] = new HashSet<NPlayer>();
            }
        }
        ...
        void IInRoomCallbacks.OnPlayerPropertiesUpdate(NPlayer targetPlayer, Hashtable changedProps)
        {
            object temp;
        ...
        void IInRoomCallbacks.OnPlayerLeftRoom(NPlayer otherPlayer)
        {
        ...
        void IInRoomCallbacks.OnPlayerEnteredRoom(NPlayer newPlayer)
        {
        ...
        private void UpdateTeams()
        {
            ...
            {
                NPlayer player = PhotonNetwork.PlayerList[i];
        ...
        /// <returns>If successful or not.</returns>
        public bool TryGetTeamMembers(byte code, out NPlayer[] members)
        {
            members = null;
            HashSet<NPlayer> players;
            if (this.playersPerTeam.TryGetValue(code, out players))
            {
                members = new NPlayer[players.Count];
                int i = 0;
        ...
        /// <param name="members">The array of players to be filled.</param>
        /// <returns>If successful or not.</returns>
        public bool TryGetTeamMembers(string teamName, out NPlayer[] members)
        {
            members = null;
            PhotonTeam team;
        ...
        /// <param name="members">The array of players to be filled.</param>
        /// <returns>If successful or not.</returns>
        public bool TryGetTeamMembers(PhotonTeam team, out NPlayer[] members)
        {
            members = null;
            if (team != null)
            {
        ...
        /// <returns>If successful or not.</returns>
        public bool TryGetTeamMatesOfPlayer(NPlayer player, out NPlayer[] teamMates)
        {
            teamMates = null;
            if (player == null)
            {
            ...
            if (this.playersPerTeam.TryGetValue(team.Code, out players))
            {
                ...
                teamMates = new NPlayer[players.Count - 1];
                int i = 0;
        ...
        void IInRoomCallbacks.OnMasterClientSwitched(NPlayer newMasterClient)
        {
        }
    ...
    public static class PhotonTeamExtensions
    {
        ...
        public static PhotonTeam GetPhotonTeam(this NPlayer player)
        {
            object teamId;
            PhotonTeam team;
        ...
        /// <returns></returns>
        public static bool JoinTeam(this NPlayer player, PhotonTeam team)
        {
            if (team == null)
            {
        ...
        /// <returns></returns>
        public static bool JoinTeam(this NPlayer player, byte teamCode)
        {
            PhotonTeam team;
        ...
        /// <returns></returns>
        public static bool JoinTeam(this NPlayer player, string teamName)
        {
            PhotonTeam team;
        ...
        public static bool SwitchTeam(this NPlayer player, PhotonTeam team)
        {
            if (team == null)
            {
        ...
        public static bool SwitchTeam(this NPlayer player, byte teamCode)
        {
            PhotonTeam team;
        ...
        /// <returns>If the team switch request is queued to be sent to the server or done in case offline or not joined to a room yet.</returns>
        public static bool SwitchTeam(this NPlayer player, string teamName)
        {
            PhotonTeam team;
        ...
        public static bool LeaveCurrentTeam(this NPlayer player)
        {
            PhotonTeam currentTeam = player.GetPhotonTeam();
            if (currentTeam == null)
            {
        ...
        /// <returns>If successful or not.</returns>
        public static bool TryGetTeamMates(this NPlayer player, out NPlayer[] teamMates)
        {
