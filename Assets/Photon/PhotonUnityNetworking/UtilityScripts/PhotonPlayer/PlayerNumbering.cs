...
namespace Photon.Pun.UtilityScripts
{
    ...
    public class PlayerNumbering : MonoBehaviourPunCallbacks
    {
        ...
        public static NPlayer[] SortedPlayers;
       ...
       public void RefreshData()
        {
            ...
            NPlayer[] sorted = PhotonNetwork.PlayerList.OrderBy((p) => p.ActorNumber).ToArray();

            string allPlayers = "all players: ";
            foreach (NPlayer player in sorted)
            {
    ...
    public static class PlayerNumberingExtensions
    {
        ...
        public static int GetPlayerNumber(this NPlayer player)
        {
			if (player == null) {
				return -1;
			}
        ...
        public static void SetPlayerNumber(this NPlayer player, int playerNumber)
        {
			if (player == null) {
				return;
			}
