...
namespace Photon.Pun.UtilityScripts
{
    ...
    {
        public static void SetScore(this NPlayer player, int newScore)
        {
        ...
        public static void AddScore(this NPlayer player, int scoreToAddToCurrent)
        {
        ...
        public static int GetScore(this NPlayer player)
        {
            object score;
