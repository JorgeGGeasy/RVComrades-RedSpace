...
namespace Photon.Pun.UtilityScripts
{
    ...
    public class PunTeams : MonoBehaviourPunCallbacks
    {
        ...
        public static Dictionary<Team, List<NPlayer>> PlayersPerTeam;
        ...
        public void Start()
        {
            PlayersPerTeam = new Dictionary<Team, List<NPlayer>>();
            Array enumVals = Enum.GetValues(typeof(Team));
            foreach (var enumVal in enumVals)
            {
                PlayersPerTeam[(Team)enumVal] = new List<NPlayer>();
            }
        }
        ...
        /// <remarks>Called by PUN. See enum MonoBehaviourPunCallbacks for an explanation.</remarks>
        public override void OnPlayerPropertiesUpdate(NPlayer targetPlayer, Hashtable changedProps)
        {
            this.UpdateTeams();
        }

        public override void OnPlayerLeftRoom(NPlayer otherPlayer)
        {
            this.UpdateTeams();
        }
    ...
    public static class TeamExtensions
    {
        ...
        public static PunTeams.Team GetTeam(this NPlayer player)
        {
            object teamId;
        ...
        public static void SetTeam(this NPlayer player, PunTeams.Team team)
        {
